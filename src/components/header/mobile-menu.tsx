            ...
            {navigationItems.map((navItem) => (
              <li key={navItem.id}>
                <NavLink
                  href={navItem.href}
                  onNavigate={onClose}
                  className="flex w-full items-center justify-between rounded-lg px-4 py-3 text-left text-base font-medium text-stone-900 transition-colors hover:bg-orange-50 hover:text-orange-700 dark:text-stone-100 dark:hover:bg-orange-950/30 dark:hover:text-orange-400"
                >
